 ...
 * NLVoltar.destino() para devolver o usuário à página de origem (ou ao dashboard).
 *
...
(function () {
  ...
  /** Destino após o login: o ?voltar= da URL, se permitido; senão o dashboard. */
  function destino() {
    try {
